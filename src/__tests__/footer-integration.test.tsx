...
describe('Footer Integration', () => {
  ...
  it('has correct href attributes for other links', () => {
    ...
    expect(screen.getByRole('link', { name: 'Content Items' })).toHaveAttribute('href', '/content-items')
    expect(screen.getByRole('link', { name: 'Document Builder' })).toHaveAttribute('href', '/document-builder')
  ...
  it('displays company information', () => {
    ...
    expect(screen.getByText(/Streamline your job search with intelligent application management/)).toBeInTheDocument()
  })
  ...
  it('displays copyright information', () => {
    ...
    expect(screen.getByText(`© ${currentYear} Job Finder App Manager. All rights reserved.`)).toBeInTheDocument()
  })
