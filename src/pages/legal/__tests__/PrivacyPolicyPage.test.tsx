...
describe('PrivacyPolicyPage', () => {
  ...
  it('contains specific privacy content', () => {
    ...
    expect(screen.getByText(/We implement appropriate technical and organizational/)).toBeInTheDocument()
  })
  ...
  it('renders data collection list items', () => {
    ...
    expect(screen.getByText('Personal information (name, email address, phone number)')).toBeInTheDocument()
  ...
  it('renders usage list items', () => {
    ...
    expect(screen.getByText('Send technical notices, updates, and support messages')).toBeInTheDocument()
  })
