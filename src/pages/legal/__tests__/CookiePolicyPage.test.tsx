...
describe('CookiePolicyPage', () => {
  ...
  it('renders cookie management list items', () => {
    ...
    expect(screen.getByText('Browser settings: Most browsers allow you to refuse or accept cookies')).toBeInTheDocument()
    expect(screen.getByText('Cookie preferences: Use our cookie preference center to manage your choices')).toBeInTheDocument()
    expect(screen.getByText('Opt-out tools: Use industry opt-out tools for advertising cookies')).toBeInTheDocument()
  })
