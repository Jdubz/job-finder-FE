...
describe('DisclaimerPage', () => {
  ...
  it('contains specific disclaimer content', () => {
    ...
    expect(screen.getByText(/The information on this website is provided on an "as is" basis/)).toBeInTheDocument()
  ...
  it('renders job search guarantees list items', () => {
    ...
    expect(screen.getByText('Compatibility with specific employers or positions')).toBeInTheDocument()
  })

  it('renders user responsibility list items', () => {
    render(<DisclaimerPage />)
    
    expect(screen.getByText('Verifying the accuracy of information before acting on it')).toBeInTheDocument()
    expect(screen.getByText('Conducting their own research and due diligence')).toBeInTheDocument()
    expect(screen.getByText('Making informed decisions about their career and job search')).toBeInTheDocument()
