...
const FIELD_CONFIGS = {
  company: [
    ...
    { name: "endDate", label: "End Date (leave empty for Present)", type: "month", placeholder: "Leave empty for Present" },
    { name: "summary", label: "Summary", type: "textarea", rows: 4, placeholder: "Brief overview of your role and responsibilities..." },
    { name: "accomplishments", label: "Accomplishments (one per line)", type: "textarea", rows: 6, placeholder: "Led team of 5 developers\nIncreased performance by 40%\nImplemented CI/CD pipeline" },
    { name: "technologies", label: "Technologies (comma-separated)", placeholder: "React, TypeScript, Node.js, PostgreSQL" },
  ...
  project: [
    ...
    { name: "description", label: "Description", type: "textarea", rows: 4, required: true, placeholder: "Brief description of the project..." },
    { name: "context", label: "Context", type: "textarea", rows: 2, placeholder: "Additional context or background..." },
  ...
  skillGroup: [
    { name: "category", label: "Category", required: true, placeholder: "e.g., Programming Languages, Frameworks, Tools" },
    { name: "skills", label: "Skills (comma-separated)", type: "textarea", rows: 3, required: true, placeholder: "React, TypeScript, Node.js" }
  ],
  textSection: [
...
export const GenericContentEdit: React.FC<GenericContentEditProps> = ({ data, onChange, type }) => {
  ...
  const typeKey = type === "skill-group" ? "skillGroup" : 
                  type === "text-section" ? "textSection" :
                  type === "profile-section" ? "profileSection" :
                  type === "timeline-event" ? "timelineEvent" : type
